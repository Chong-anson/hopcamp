...
ActiveRecord::Schema.define(version: 2020_04_15_021627) do
  ...
  create_table "campsite_taggings", force: :cascade do |t|
    t.integer "campsite_id", null: false
    t.integer "tag_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["campsite_id", "tag_id"], name: "index_campsite_taggings_on_campsite_id_and_tag_id", unique: true
  end
  ...
  create_table "reviews", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["campsite_id", "user_id"], name: "index_reviews_on_campsite_id_and_user_id", unique: true
  end
