...
class Splash extends React.Component {
  ...
  render() {
    ...
    const longTiles = [
      {
        heading: "Unique Tiny House",
        subheading: "Small & stylish",
        imgUrl: "splash-photo-1.jpg",
      },
      {
        heading: "Animal Experience",
        subheading: "Horses, camels, goats & more",
        imgUrl: "splash-photo-2.jpg",
      },
      {
        heading: "Stunning Sunshine State",
        subheading: "Colorful camping & glamping",
        imgUrl: "splash-photo-3.jpg",
      },
    ].map((el) => (
      ...
      <div className="splash-content">
        ...
        <div className="banner become-host">
          <div className="banner-description">
            ...
            <p>
              Help more people spend time outside. Share your land with campers,
              glampers, and RV travelers.
            </p>
        ...
        <div className="splash-container">
          ...
          <div className="splash-items-container">{longTiles}</div>
        </div>
        <div className="splash-container">
          <h2>Destination getaways.</h2>
          <div className="splash-items-container">{citiesList}</div>
        </div>
