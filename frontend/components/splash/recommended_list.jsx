...
export default (props) => {
  const recommendedList = [
    ...
    },
    {
      ...
      imgUrl: "Mount-Rainier.jpg",
    },
    {
      lat: 37.593,
      lng: -112.1871,
      heading: "Bryce Canyon",
      subHeading: "Utah",
      imgUrl: "Bryce-Canyon.jpg",
    },
    {
      lat: 36.108859,
      lng: -112.074237,
    ...
    },
    {
      lat: 35.6532,
      lng: -83.507,
      heading: "Great Smoky Mountains",
      subHeading: "Tennessee",
      imgUrl: "Great-Smoky-Mountains.jpg",
    },
    {
      lat: 29.1275,
      lng: -103.2425,
  ...
  const result = recommendedList.map((el, idx) => {
    return (
      <div className="recommended-list-item" key={`recommendation-${idx}`}>
        <Link to={`search?lat=${el.lat}&lng=${el.lng}&res=${el.heading}`}>
  ...
  return <div className="recommended-list-container">{result}</div>;
};
