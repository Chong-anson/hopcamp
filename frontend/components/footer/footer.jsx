    ...
    <div className="footer">
      ...
      <div className="footer-left">
        <div className="footer-left-section">
          ...
          <p>If you would like to see more of my work, please visit my personal 
      ...
      <div className="footer-right">
        <h2 className="footer-title"> About Hopcamp, a pixel-perfect clone of Hipcamp</h2>
          <p>
            Hopcamp is built using PostgreSQL, Ruby on Rails, ReactJS and Redux.
            To enhance user experience, I've incorporated Goolge Maps API, AWS S3, 
            OpenWeather API.             
          </p>
      </div>
