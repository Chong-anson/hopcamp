...
const BookingWidget = (props) => {
  ...
  const booking = useSelector((state) => state.ui.payment);
  const handleTab = (tab) => {
    setTab(tab);
  };
  ...
  let bookingForm = (
    <BookingFormContainer campsite={campsite} setTab={handleTab} />
  );
  ...
  if (tab === "checkout") {
    ...
    bookingForm = (
      <div className="payment-form">
        ...
        <div className="booking-submit-btn">
          <button className="special-buttons-2" onClick={handleCheckOut}>
            Check out!
          </button>
        </div>
      </div>
    ...
    bookingForm = (
      <div className="payment-form">
        ...
        <div className="booking-submit-btn">
          <button className="special-buttons-2" onClick={handleConfirm}>
  ...
  return (
    <div className="booking-widget">
      {bookingForm}
      <BookingList user={currentUser} campsiteId={campsite.id} />
    </div>
  );
};
